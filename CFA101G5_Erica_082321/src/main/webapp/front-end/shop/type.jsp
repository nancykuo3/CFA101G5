...
<%
Integer typeId = new Integer(request.getParameter("type"));
...
<div class="container" style="height: 100%">
    <div class="content mt-5 p-3">
        <div class="subtitle">商品類型: ${shopSvc.getTypeName(typeId)}</div>
    </div>	
    <div class="content mt-1 mb-5" style="height: 100%">
        
        <div class="row content-row">
            <c:forEach var="prodVO" items="${shopSvc.getProdByType(typeId)}" varStatus="s">
