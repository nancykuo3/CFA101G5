...
<%
	...
	List<StoreReportVO> storeReportVOList = storeReportService.getAll();
        ...
        <div class="d-flex flex-column" id="content-wrapper">
            ...
            <div style="margin:20px 15px;">		
				<div class="container">
					<div class="row align-items-center" style="margin-top: 100px;">
						...
						<div class="col-4" style="margin-right: 50px">
							...
							<div class="row left_font" style="margin-top: 30px">
							...
							<div class="row" style="margin-top: 25px">
								<div class="list-group">
									<a id="account_button" href="<%=request.getContextPath() + "/back-end/mem/allMem.jsp"%>" style="background-color: #eeeeee; height: 45px;" class="list-group-item list-group-item-action">
										<div class="row">
									...
									<a  href="<%=request.getContextPath() + "/back-end/store/allStore.jsp"%>" style="background-color: #eeeeee; height: 45px;" class="list-group-item list-group-item-action">
										<div class="row">
											<div class="col-2" style="border-right: 1px solid #cccccc;">
												<i class="fas fa-user"></i>
											</div>
									...
									<a  href="<%=request.getContextPath() + "/back-end/report/memReport.jsp"%>" style="background-color: #eeeeee; height: 45px;" class="list-group-item list-group-item-action">
										<div class="row">
											<div class="col-2" style="border-right: 1px solid #cccccc;">
									...
									<a  href="<%=request.getContextPath() + "/back-end/report/storeReport.jsp"%>" style="background-color: #eeeeee; height: 45px;" class="list-group-item list-group-item-action">
										<div class="row">
											<div class="col-2" style="border-right: 1px solid #cccccc;">
												<i class="far fa-frown"></i>
											</div>
						...
						<div class="col-7">
							<div class="row">
								<div class="row left_font" style="margin-top: 25px">
									<h1 style="font-weight: bold;">
										<font face="monospace">&nbsp&nbsp 店家會員檢舉管理</font>
									</h1>
								</div>
							</div>
							...
							<div class="row table-responsive">
								...
								<div class="input-group flex-nowrap">
									<span class="input-group-text" id="addon-wrapping">單號：</span> <input id="myInput" type="text" placeholder="Search for name" class="form-control" placeholder="Username" aria-label="Username" aria-describedby="addon-wrapping">
								</div>
								<table class="table table-striped table-hover">
									...
									<tbody id="myTable">
										<%
											for (int i = 0; i < storeReportVOList.size(); i++) {
										%>
										<tr>
											<td scope="row"><%=storeReportVOList.get(i).getReportno()%></td>
											<td><%=storeReportVOList.get(i).getAdminid()%></td>
											<td><%=storeReportVOList.get(i).getStatus() == 0 ? "未處理" : "已處理"%></td>
											<td>
											<%
												if (storeReportVOList.get(i).getStatus() == 1) {
													%> <%=storeReportVOList.get(i).getResult() == 1 ? "不通過" : "通過"%> <%	
					...
					<%-- 					<td><%=storeReportVOList.get(i).getNote()%></td> --%>
											<td>
													<%=storeReportVOList.get(i).getNote()%>
											</td>		
											<td>
												<button type="button" name="button_<%=i%>" data-id="<%=storeReportVOList.get(i).getMemid()%>" class="btn btn-outline-info" data-bs-toggle="modal" data-bs-target="#exampleModal<%=i%>">查看</button>								
												 <% if (storeReportVOList.get(i).getStatus() == 0) {%>
												<button type="button" name="" data-id="<%=storeReportVOList.get(i).getMemid()%>" class="btn btn-outline-info" data-bs-toggle="modal" data-bs-target="#updateModal<%=i%>">審核</button>
												...
												<div class="modal-content">
													...
													<div class="modal-body">
														...
														<div class="mb-3">
															...
															<div><%=storeReportVOList.get(i).getMemid()%></div>
														</div>

														<div class="mb-3">
															<label for="exampleFormControlInput1" class="form-label"><font>[店家會員編號]</font></label>
															<div><%=storeReportVOList.get(i).getStoreid()%></div>
														</div>	
														
														<div class="mb-3">
															<label for="exampleFormControlInput1" class="form-label"><font>[檢舉內容]</font></label>
															<div><%=storeReportVOList.get(i).getContent()%></div>
														</div>
													</div>
										...
										<div class="modal fade" id="updateModal<%=i%>" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
											<div class="modal-dialog">
												<div class="modal-content">
													...
													<div class="modal-body">
														<!-- 									model內文 -->
														<form id=""    action="<%=request.getContextPath()%>/report/storeReportServlet">>
															<div class="mb-3">
																<label for="exampleFormControlInput1" class="form-label"><font>檢舉單號</font></label>
																&nbsp;
																<input type="text" name="reportno" value="<%=storeReportVOList.get(i).getReportno()%>">
															</div>
				...
				<form style="display: none;" action="<%=request.getContextPath()%>/store/StoreServlet" id="update_form" method="post">
					<input id="storeId" name="storeId"> <input id="status" name="status"> <input value="getOne_For_Update" name="action">
				</form>
            </div>
