...
<!-- 最佳兼容模式 -->
<link rel="stylesheet" href="<%=request.getContextPath()%>/back-end/admin/style.css">
<title>管理員登入</title>
		...
		<div class="col-2">
			<div class="login">
				<FORM METHOD="post" ACTION="<%=request.getContextPath()%>/login/LoginServlet">
					...
					<input class="form-control" type="text" placeholder="請輸入帳號" name="acc" size="5" value="ts@gmail.com" /> ${errorMsgs} 
					<font color=white>密碼</font> 
					<input class="form-control" type="password" placeholder="請輸入密碼" size="5" name="pwd" value="handsomeguy" /> ${errorMsgs} 
