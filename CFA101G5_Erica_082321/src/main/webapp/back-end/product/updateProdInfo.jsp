		    ...
		    <div style="margin:20px 15px;">
		    	<div style="display:flex">
					...
					<div style="position:absolute; right:15px;">
						<h4>
							<a
								href="<%=request.getContextPath()%>/back-end/product/listAllType.jsp">取消修改，回列表清單</a>
						</h4>
					</div>
		    	</div>
				...
				<div>
					<form method="post"
						...
						<table>
							...
							<tr>
								<td>遊戲名稱：<b style="color: red">*</b></td>
								<td><input type="text" name="prodName"
									value="${prodInfoVO.prodName}" maxlength="50" required></td>
							</tr>
							<tr>
								<td>語言：<b style="color: red">*</b></td>
								<td><input type="text" name="prodLang"
									value="${prodInfoVO.prodLang}" maxlength="20" required></td>
							</tr>
							<tr>
								<td>版本：<b style="color: red">*</b></td>
								<td><input type="text" name="prodVer"
									value="${prodInfoVO.prodVer}" maxlength="20" required></td>
							</tr>
							...
							<tr>
								...
								<td><c:forEach var="typeVO" items="${typeSvc.all}">
										<input type="checkbox" name="typeid" value="${typeVO.typeid}"
											<c:forEach var="getTypesByISBNVO" items="${set}">
												${(typeVO.typeName==getTypesByISBNVO.typeName)?'checked':'' }
											</c:forEach>>${typeVO.typeName}
									</c:forEach></td>
							</tr>
						</table>
						...
						<button type="submit" name="action" value="updateProdInfo" class="btn back-end-btn" style="color:#7f70f5; border-color:#7f70f5">送出修改</button>
						<button type="reset" class="btn back-end-btn" style="color:#7f70f5; border-color:#7f70f5">重設</button>
						<!-- Button trigger modal -->
			<!-- 			<button type="submit" name="action" value="updateProdInfo"
							class="btn btn-primary" data-bs-toggle="modal"
							data-bs-target="#staticBackdrop">送出修改</button> -->
					</form>
				</div>
		    </div>
