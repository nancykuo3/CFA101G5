				...
				<div>
					<form method="post"
						...
						<table>
							...
							<tr>
								<td>名稱：<b style="color: red">*</b></td>
								<td><input type="text" name="typeName"
									value="${typeVO.typeName}" minlength="2" maxlength="20" required /></td>
							</tr>
							...
							<tr>
								...
								<td><select size="1" name="typeClass" required>
										<c:forEach var="typeClassVO" items="${typeSvc.classList}">
											<option value="${typeClassVO.typeClass}"
												${(typeVO.typeClass==typeClassVO.typeClass)?'selected':'' }>${typeClassVO.typeClass}
										</c:forEach>
								</select></td>
							</tr>
						</table>
						...
						<button type="submit" name="action" value="updateType" class="btn back-end-btn" style="color:#7f70f5; border-color:#7f70f5; margin-top:2px">送出修改</button>
						<button type="reset" class="btn back-end-btn" style="color:#7f70f5; border-color:#7f70f5; margin-top:2px">重設</button>
					</form>
				</div>
		    </div>
