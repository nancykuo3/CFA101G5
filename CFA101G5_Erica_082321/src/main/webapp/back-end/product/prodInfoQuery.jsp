		    ...
		    <div style="padding:20px 15px;">
		    	<div style="display: flex;">
					...
					<div style="display:flex; position:absolute; right:15px;">
						<a href="<%=request.getContextPath()%>/back-end/back-end-index.jsp" style="padding:3px;">
							<button type="button" class="btn back-end-btn" style="color:#7f70f5; border-color:#7f70f5">回首頁</button>
						</a>
						<a href="<%=request.getContextPath()%>/back-end/product/addProdInfo.jsp" style="padding:3px;">
							<button type="button" class="btn back-end-btn" style="color:#7f70f5; border-color:#7f70f5">新增商品詳細資料</button>
						</a>
					</div>
		    	</div>
				
				<div id="formStyle" style="width:100%;">
					<form method="post" class="form-inline" 
						action="<%=request.getContextPath()%>/productInfo/ListProdInfo_ByCompositeQueryServlet">
						...
						<div class="form-group" style="margin:1%">
							<label for="isbn">ISBN</label>
								...
								<input type="text" class="form-control" name="isbn" id="isbn"
									maxlength="20" size="15" pattern="\d{0,20}">
							
						</div>
						<div class="form-group" style="margin:1%">
							<label for="prodName">名稱</label>
				...
				<%
				if (request.getAttribute("listProdInfoByCompositeQuery") != null) {
				%>
				<jsp:include page="/back-end/product/listAllProdInfo_compositeQuery.jsp" />
				<%
				} else {
				%>
				<jsp:include page="/back-end/product/listAllProdInfo.jsp" />
				<%
				}
				
				if(request.getAttribute("listProds_By_ISBN") != null) {
				%>
				<jsp:include page="/back-end/product/listProdsByISBN.jsp" />
				<%
				}
				%>
		    </div>
