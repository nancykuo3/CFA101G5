...
/**
 * Servlet implementation class AddProdInfoServlet
 */
@WebServlet("/productInfo/AddProdInfoServlet")
public class AddProdInfoServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;

	/**
	 * @see HttpServlet#HttpServlet()
	 */
	public AddProdInfoServlet() {
		super();
		...
		if ("insert".equals(action)) {
			...
			try {
				...
				if (!errorMsgs.isEmpty()) {
					...
					RequestDispatcher failureView = request.getRequestDispatcher("/back-end/product/addProdInfo.jsp");
